...
from app.openAPI.openai import generate_openai_response, generate_openai_response_with_vision, create_vision_message
...
async def insert_message(
    ...
    # Generate AI response based on whether image is present
